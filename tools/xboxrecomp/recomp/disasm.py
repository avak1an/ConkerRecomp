...
class Operand:
    ...
    # Segment override, e.g. "fs" for the thread block. Dropping it silently
    # turns fs:[0x20] into a read of guest address 0x20, which is ordinary
    # Xbox RAM the title allocates out of -- see RECOMP_FS_BASE.
