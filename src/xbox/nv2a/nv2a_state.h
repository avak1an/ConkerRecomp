...
/* RAMHT handle resolution (nv2a_core.c).  Push-buffer methods name graphics
 * objects and DMA contexts by handle; these turn a handle into the PRAMIN
 * instance offset, and into the guest address range a context DMA covers. */
